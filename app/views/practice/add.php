...
<div class="container">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h2 class="card-title">Add Practice Test</h2>
        </div>
        <div class="card-body">
            <form action="<?php echo URLROOT; ?>/practice/add" method="post">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="name">Test Name <sup>*</sup></label>
                            <input type="text" name="name" class="form-control <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['name']; ?>" placeholder="e.g., Cambridge IELTS 14 Test 1">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="notes" class="form-control" rows="3" placeholder="Any observations or comments about this test"><?php echo $data['notes']; ?></textarea>
                        </div>
                    </div>
                ...
                <div class="form-group text-center">
                    ...
                    <a href="<?php echo URLROOT; ?>/practice" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
